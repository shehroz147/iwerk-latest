...
export default function Experience3(props) {
  return (
    <div
     ...
     >
      ...
      <h2>Our<span>Experience</span> </h2>
        <div className="expabout-main-border text-center " style={{marginTop:"30px"}}>
          ...
          <span className="text-uppercase expabout-border-2" style={{ color: "#ea7726" }} 
          onClick={() => {
            props.setexppages(4)
            props.setoneTimeScroll(false)
          }}>
        ...
        <div className="container ptext text-center">
          <p>{props.experiences[4].p1}</p>
          <p>{props.experiences[4].p2}</p>
          <p>{props.experiences[4].p3}</p>
        </div>
      </div>
